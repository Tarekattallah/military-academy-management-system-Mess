...
export function RolesPage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (err: Error) => toast.error(err.message || 'فشل إنشاء الدور'),
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (err: Error) => toast.error(err.message || 'فشل تحديث الدور'),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (err: Error) => toast.error(err.message || 'فشل حذف الدور'),
  });
  ...
  function getPermissionTone(count: number) {
